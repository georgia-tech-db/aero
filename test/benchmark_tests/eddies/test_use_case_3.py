...
def test_use_case_3_baseline(benchmark, load_warehouse_videos, setup_pytorch_tests):
...
@pytest.mark.notparallel
def test_use_case_3_eddies(benchmark, load_warehouse_videos, setup_pytorch_tests, ray_fixture):
    config = ConfigurationManager()
    config.update_value("core", "mode", "debug")
