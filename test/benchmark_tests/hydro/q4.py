...
IQUERY1 = """SELECT YoloV5(data).labels FROM WarehouseVideo
    WHERE id > 1000 AND id < 7000;"""
IQUERY2 = """SELECT HardHatDetector(data).labels FROM WarehouseVideo
...
def test_evadb(benchmark, setup_pytorch_tests):
    ...
    execute_query_fetch_all(IQUERY1)
    execute_query_fetch_all(IQUERY2)
