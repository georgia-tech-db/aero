...
def test_use_case_5_baseline(benchmark, load_dog_videos, setup_pytorch_tests):
...
@pytest.mark.notparallel
def test_use_case_5_hydro(benchmark, load_dog_videos, setup_pytorch_tests, ray_fixture):
    config = ConfigurationManager()
    config.update_value("core", "mode", "debug")
