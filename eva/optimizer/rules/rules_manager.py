...
from eva.experimental.eddy.optimizer.rules import (
    LogicalFilterToPhysical as AdaptiveLogicalFilterToPhysical,
)
from eva.experimental.eddy.optimizer.rules import (
    LogicalGetToSeqScan as AdaptiveLogicalGetToSeqScan,
)
...
class RulesManager:
    def __init__(self):
        ...
        eddy_enabled = ConfigurationManager().get_value("experimental", "eddy")

        if eddy_enabled:
            self._implementation_rules += [
                # AdaptiveLogicalGetToSeqScan(),
                AdaptiveLogicalFilterToPhysical(),
