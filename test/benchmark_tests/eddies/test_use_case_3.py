...
def test_use_case_3_baseline(benchmark, load_warehouse_videos, load_video_udfs):
...
@pytest.mark.notparallel
def test_use_case_3_eddies(benchmark, load_warehouse_videos, load_video_udfs, ray_fixture):
    config = ConfigurationManager()
    config.update_value("core", "mode", "debug")
