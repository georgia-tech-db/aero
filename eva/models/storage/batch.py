...
class RoutingBatch:
    """
    Routing batch for queues.
    """

    def __init__(self, batch, unique_id: int = None, debug_info: str = ""):
        self.batch = batch
        self.unique_id = unique_id
        self.debug_info = debug_info

        # Passed along statistics.
        self.stats_dict = defaultdict(lambda: None)

        # Additional flags.
        self.flags_dict = defaultdict(lambda: None)

        # Status.
        self.status = RoutingBatchStatus.InProgress
...
class Batch:
    ...
    def deserialize(cls, data):
        ...
        return cls(frames=obj["frames"], unique_id=obj["unique_id"])
